...
document.addEventListener("DOMContentLoaded", () => {
  ...
  speakButton.innerHTML = '<ion-icon name="volume-high-outline"></ion-icon>';
  speakButton.id = "speak-btn";
  document.querySelector(".output-wrapper").appendChild(speakButton);
  ...
  speakButton.addEventListener("click", () => {
      ...
      speech.rate = 1; // Adjust speaking speed if needed
